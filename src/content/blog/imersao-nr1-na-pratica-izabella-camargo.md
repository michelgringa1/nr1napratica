---
title: "Imersão NR1 na Prática da Izabella Camargo: o que é e vale a pena?"
seoTitle: "Imersão NR1 na Prática (Izabella Camargo): Vale a Pena?"
description: "O que é a imersão NR1 na Prática da Izabella Camargo, para quem é, o que esperar e como ela se conecta à Formação Gestor de NR1. Análise independente."
funnel: "BOFU"
...
faq:
  ...
  - q: "A imersão é a mesma coisa que a Formação Gestor de NR1?"
    a: "<p>Não. A imersão costuma ser um evento/experiência mais curta e introdutória, enquanto a <a href='/formacao-gestor-de-nr1-izabella-camargo-review/'>Formação Gestor de NR1</a> é o programa completo, com 12 módulos, corpo docente e certificado. A imersão normalmente serve de porta de entrada para a formação.</p>"
  - q: "Vale a pena participar da imersão?"
...
## Quem é Izabella Camargo

Vale o contexto, porque a autoria pesa num tema sério como esse. Izabella Camargo é **jornalista** (ex-TV Globo), tornou-se referência em **saúde mental no trabalho** após expor o próprio caso de burnout, criou o conceito dos **"EPIs da Saúde Mental"**, é **LinkedIn Top Voice**, palestrante **TEDx** e foi premiada como uma das maiores vozes de RH do Brasil. Ou seja: autoridade construída no tema antes de a NR-1 virar obrigação.
...
| | Imersão "NR1 na Prática" | Formação Gestor de NR1 |
|---|---|---|
| **Objetivo** | Apresentar o tema e a abordagem | Formar o profissional para atuar |
| **Profundidade** | Introdutória | Completa (12 módulos) |
| **Certificado** | Geralmente não | Sim (extensão universitária) |
| **Melhor para** | Decidir se a área é para você | Entrar de fato no mercado |
